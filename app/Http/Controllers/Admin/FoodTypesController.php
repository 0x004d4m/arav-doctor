...
class FoodTypesController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setModel("App\Models\FoodType");
        $this->crud->setRoute("admin/FoodTypes");
        $this->crud->setEntityNameStrings('FoodType', 'Food Types');
    }
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->setColumnDetails('name_en',['label' => "Name EN",'name' => "name_ar",'type' => 'text']);
        $this->crud->setColumnDetails('name_fr',['label' => "Name FR",'name' => "name_ar",'type' => 'text']);
    }
