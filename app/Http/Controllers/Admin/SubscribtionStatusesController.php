...
class SubscribtionStatusesController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setModel("App\Models\SubscribtionStatus");
        $this->crud->setRoute("admin/SubscribtionStatuses");
        $this->crud->setEntityNameStrings('Subscribtion Status', 'Subscribtion Statuses');
    }
