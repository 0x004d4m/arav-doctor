...
class CaloriesStatusesController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setModel("App\Models\CaloriesStatus");
        $this->crud->setRoute("admin/CaloriesStatuses");
        $this->crud->setEntityNameStrings('Calories Status', 'Calories Statuses');
    }
