...
class InsuranceCompaniesController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setModel("App\Models\InsuranceCompany");
        $this->crud->setRoute("admin/InsuranceCompanies");
        $this->crud->setEntityNameStrings('Insurance Company', 'Insurance Companies');
    }
