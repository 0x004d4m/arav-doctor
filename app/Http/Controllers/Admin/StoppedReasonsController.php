...
class StoppedReasonsController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setModel("App\Models\StoppedReason");
        $this->crud->setRoute("admin/StoppedReasons");
        $this->crud->setEntityNameStrings('Stopped Reason', 'Stopped Reasons');
    }
